...
public class DepositOutputActivity extends AppCompatActivity {

    private static final int STORAGE_CODE = 1000;

    TextView depositAccountNumber;
    TextView transactionType;
    TextView depositAvailableBalance;
    TextView depositRrn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView (R.layout.activity_deposit_output);

        depositAccountNumber = (TextView) findViewById (R.id.textViewDepositAccountNumber);
        transactionType = (TextView) findViewById (R.id.textViewDepositTransactionType);
//        withdrawAvailableBalance = (TextView) findViewById (R.id.textViewWithdrawAccountBalance);
       ...
       // depositAccountNumber.setText (depositAccountNo);
        ...
        depositAmount.setText (depositAmount1 + " INR");
        depositDate.setText (depositDate1);
        depositStatus.setText ("Successful");

        buttonPrintDeposit.setOnClickListener (new View.OnClickListener () {
            @Override
    ...
    private void savePdf() {
        ...
        String mFilePath = Environment.getExternalStorageDirectory() + "/" + "Mint" + "/" + "AepsDeposit_" + mFileName + ".pdf";
        try {
            PdfWriter.getInstance(mDoc, new FileOutputStream (mFilePath));;
            mDoc.open();
            String heading = "-- Transaction Report --";
            String pdfText = depositAccountNumber.getText().toString();
            String pdfText1 = depositRrn.getText ().toString ();
            String pdfText2 = transactionType.getText ().toString ();
            String pdfText3 = depositAmount.getText ().toString ();
            String pdfText4 = depositDate.getText ().toString ();
            ...
            mDoc.add (new Paragraph ("Deposit Amount : " + pdfText3));
            mDoc.add (new Paragraph ("Deposit Date : " + pdfText4));
            mDoc.close ();
